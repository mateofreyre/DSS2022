...
{
    public partial class AddCollectionAndModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlazoFabricacion = table.Column<int>(type: "int", nullable: false),
                    FechaLanzamientoEstimada = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
